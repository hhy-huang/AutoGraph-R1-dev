...
CHECKPOINT_DIR="/data/tht/AutoGraph-R1/checkpoints/${TIMESTAMP}_qwen2.5-3b-judge-1.5B-autograph-distract_${DIFFFICULTY}-docsize${DOC_SIZE}-textlinking${TEXT_LINKING}-f1${F1_REWARD}"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen2.5-3B-auto-graph-rl-distract-${DIFFFICULTY}-docsize${DOC_SIZE}-text-linking${TEXT_LINKING}-deduce-${DEDUCE_REWARD}-loose-1.5B-Judge" \
    ...
    actor_rollout_ref.rollout.llm_judge_model_name='Qwen/Qwen2.5-3B-Instruct' \
