...
CHECKPOINT_DIR="/data/tht/AutoGraph-R1/checkpoints/${TIMESTAMP}_qwen2.5-7b-judge-3B-autograph-distract_${DIFFFICULTY}-docsize${DOC_SIZE}-textlinking${TEXT_LINKING}-f1${F1_REWARD}"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen2.5-7b-auto-graph-rl-distract-${DIFFFICULTY}-docsize${DOC_SIZE}-graph-retriever-deduce-${DEDUCE_REWARD}-tight-${TIGHT}-3B-Judge" \
