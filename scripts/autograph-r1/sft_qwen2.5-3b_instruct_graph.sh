...
torchrun --rdzv_endpoint=127.0.0.1:12888 -m verl.trainer.fsdp_sft_trainer \
    ...
    trainer.experiment_name=autograph-sft-qwen2.5-3b-instruct-5step \
    trainer.total_epochs=5 \
    trainer.n_gpus_per_node=1 \
    trainer.logger='["console","wandb"]'\
    trainer.default_local_dir="/data/tht/AutoGraph-R1/checkpoints/sft_qwen2.5-3b_instruct-5step" \