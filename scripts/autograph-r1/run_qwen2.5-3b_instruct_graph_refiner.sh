...
if [ "$MIX_DATA" = "True" ] && [ "$ITERATIVE" = "False" ]; then
    ...
    if [ "$REFINEMTN" = "True" ]; then
        ...
        TRAIN_DATA="/data/haoyuhuang/data/AtlasTune/data/hotpotqa_train_refinement.parquet"
        VAL_DATA="/data/haoyuhuang/data/AtlasTune/data/hotpotqa_valid_refinement.parquet"
    else
