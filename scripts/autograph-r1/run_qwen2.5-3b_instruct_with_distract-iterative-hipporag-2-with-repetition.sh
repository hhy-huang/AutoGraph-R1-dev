...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="azure-qwen2.5-3b-auto-graph-rl-distract-${DIFFFICULTY}-docsize${DOC_SIZE}-text-linking${TEXT_LINKING}-deduce-${DEDUCE_REWARD}-hipporag2-tight" \
